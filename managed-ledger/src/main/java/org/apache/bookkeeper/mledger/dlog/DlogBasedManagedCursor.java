...
public class DlogBasedManagedCursor implements ManagedCursor {
    ...
    class PendingMarkDeleteEntry {
        ...
        public PendingMarkDeleteEntry(DlogBasedPosition newPosition, MarkDeleteCallback callback, Object ctx) {
    ...
    private void recoveredCursor(DlogBasedPosition position) {
    ...
    private void persistPositionMetaStore(long cursorsLedgerId, DlogBasedPosition position,
        ...
        bookkeeper.asyncCreateLedger(config.getMetadataEnsemblesize(), config.getMetadataWriteQuorumSize(),
                config.getMetadataAckQuorumSize(), config.getDigestType(), config.getPassword(), (rc, lh, ctx) -> {
                    ledger.getExecutor().submit(safeRun(() -> {
                        ...
                        // content
                        final DlogBasedPosition position = (DlogBasedPosition) getMarkDeletedPosition();
    ...
    void persistPosition(final LedgerHandle lh, final DlogBasedPosition position, final VoidCallback callback) {
