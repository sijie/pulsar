...
public class DlogBasedMetaStoreImplZookeeper implements MetaStore {
    ...
    public DlogBasedMetaStoreImplZookeeper(ZooKeeper zk, OrderedSafeExecutor executor)
            throws Exception {
        this.zk = zk;
    ...
    private static final Logger log = LoggerFactory.getLogger(DlogBasedMetaStoreImplZookeeper.class);
}
