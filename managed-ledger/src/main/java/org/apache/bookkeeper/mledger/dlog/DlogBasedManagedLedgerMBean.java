...
public class DlogBasedManagedLedgerMBean implements ManagedLedgerMXBean {
    ...
    private final DlogBasedManagedLedger managedLedger;
    ...
    public DlogBasedManagedLedgerMBean(DlogBasedManagedLedger managedLedger) {
