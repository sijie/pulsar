...
public class DlogBasedManagedLedgerFactoryMBean implements ManagedLedgerFactoryMXBean {
    ...
    public DlogBasedManagedLedgerFactoryMBean(DlogBasedManagedLedgerFactory factory) throws Exception {
